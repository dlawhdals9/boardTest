...
function check(){
	...
	if(confirm('등록하시겠습니까?')){
		...
		$.ajax({
			type : 'get',
			url : 'UpdateCheckJumin?jumin_nof='+jumin_nof+'&jumin_nob=' + jumin_nob +'&no=' + no,
			dataType : 'json',
...
<form action="updateOK" method="post" enctype="multipart/form-data" name="userinput" id="frm">
                              ...
                              <td height="112" bgcolor="#CCCCCC"><table width="100" border="0" cellspacing="1" cellpadding="0">
                                  <tr>
                                    <td width="144"  height="110" bgcolor="#FFFFFF">
							 			<img id="preview" src="profile/${vo.image}" style="width: 100px"/>
						 			</td>
                                  </tr>
                              </table></td>
                            </tr>
                          ...
                          <td width="456"><table width="423" border="0" cellspacing="2" cellpadding="0">
                            ...
                            <tr>
                              ...
                              <td width="310" height="26">
                                <input type="text" id="kor_name" name="kor_name" value="${vo.kor_name}" onkeyup="checkName()">
                                <div id="korNameCheck" style="float: right; color: red;"></div>
                              </td>
                            </tr>
                            <tr>
                              <td height="26" align="right"><strong>영문이름 :&nbsp;</strong></td>
                              <td height="26"><input type="text" id="eng_name" name="eng_name" value="${vo.eng_name}"></td>
                            </tr>
                            <tr>
                              <td height="26" align="right"><strong>한문이름:</strong>&nbsp;</td>
                              <td height="26"><input type="text" id="chn_name" name="chn_name" value="${vo.chn_name}"></td>
                            </tr>
                            <tr>
                              <td height="26" align="right"><strong>주민등록번호 :</strong>&nbsp;</td>
                              <td height="26"><input id="jumin_nof" name="jumin_nof" type="text" size="15" value="${vo.jumin_nof}">
      -
        <input id="jumin_nob" name="jumin_nob" type="text" size="15" value="${vo.jumin_nob}"></td>
                            </tr>
                          </table></td>
                        </tr>
                      </table></td>
                    ...
                    <tr> 
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="391"><input id="birth1" name="birth1" type="text" size="10" value="${vo.birth1}">
                              년 
                              <input id="birth2" name="birth2" type="text" size="7" value="${vo.birth2}">
                              월 
                              <input id="birth3" name="birth3" type="text" size="7" value="${vo.birth3}">
                              일 ( 
                              <c:if test="${vo.sol_flag == '양력'}">
                              	<input type="radio" id="sol_flag" name="sol_flag" value="양력" checked="checked">
	                              양력 
	                              <input type="radio" id="sol_flag" name="sol_flag" value="음력">
	                              음력 )
                              </c:if>
                              <c:if test="${vo.sol_flag == '음력'}">
                              	<input type="radio" id="sol_flag" name="sol_flag" value="양력" >
	                              양력 
	                              <input type="radio" id="sol_flag" name="sol_flag" value="음력" checked="checked">
	                              음력 )
                    ...
                    <tr> 
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="391"> 
                            	<c:if test="${vo.sex == '남자'}">
	                            	<input type="radio" id="sex" name="sex" value="남자" checked="checked">
	                              	남자 
                              ...
                              <c:if test="${vo.sex == '여자'}">
	                              	<input type="radio" id="sex" name="sex" value="남자">
	                              	남자 
	                              	<input type="radio" id="sex" name="sex" value="여자" checked="checked">
	                              	여자
                              </c:if>
                      ...
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="391"> 
                            	...
                            	<c:if test="${vo.marry_flag == '유'}">
	                            	<input type="radio" id="marry_flag" name="marry_flag" value="유" checked="checked">
	                          	유 
	                           	<input type="radio" id="marry_flag" name="marry_flag" value="무">
	                        	무
	                      		</c:if>
	                      		
                              <c:if test="${vo.marry_flag == '무'}">
	                              	<input type="radio" id="marry_flag" name="marry_flag" value="유" >
	                          	유 
	                           	<input type="radio" id="marry_flag" name="marry_flag" value="무" checked="checked">
	                        	무
                              </c:if>
                    ...
                    <tr> 
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="392"><input id="work_year" name="work_year" type="text" size="10" value="${vo.work_year}"> 
                            </td>
                          </tr>
                        </table></td>
                    </tr>
                      ...
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="392"> <select name="payment_type" id="payment_type">
                            	<c:if test="${vo.payment_type == '월급'}">
                            		<option selected="selected">월급</option>
                                	<option>주급</option>
                            	</c:if>
                            	<c:if test="${vo.payment_type == '주급'}">
                            		<option>월급</option>
                                	<option selected="selected">주급</option>
                            	</c:if>
                              </select> </td>
                          </tr>
                        </table></td>
                      ...
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="392"> <select name="desire_dept" id="desire_dept">
                            	<c:if test="${vo.desire_dept == 'SI'}">
                            		<option selected="selected">SI</option>
                                	<option>SM</option>
                            	</c:if>
                            	<c:if test="${vo.desire_dept == 'SM'}">
                            		<option>SI</option>
                      ...
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="392"> <select name="jop_type" id="jop_type">
                            	<c:if test="${vo.jop_type == '정규직'}">
                            		<option selected="selected">정규직</option>
                                	<option>계약직</option>
                            	</c:if>
                            	<c:if test="${vo.jop_type == '계약직'}">
                            		<option>정규직</option>
                                	<option selected="selected">계약직</option>
                            	</c:if>
                              </select> </td>
                          </tr>
                        </table></td>
                      ...
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="392"><!-- <input name="address" type="text" size="10">  -->
                              <input name="address" id="address" type="text" size="40" value="${vo.address}"> 
                            </td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr> 
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="392"><input name="phone1" id="phone1" type="text" size="10" value="${vo.phone1}">
                              - 
                              <input name="phone2" id="phone2" type="text" size="10" value="${vo.phone2}">
                              - 
                              <input name="phone3" id="phone3" type="text" size="10" value="${vo.phone3}"></td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr> 
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="392"><input name="email" id="email" type="text" size="20" value="${vo.email}"> 
                            </td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr> 
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="392"><input name="tech_lev" id="tech_lev" type="text" size="20" value="${vo.tech_lev}"> 
                            </td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr> 
                      <td bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            ...
                            <td width="392"><input name="liquor" id="liquor" type="text" size="20" value="${vo.liquor}"> 
                            </td>
                          </tr>
                        </table></td>
                    </tr>
        ...
        <tr>
          <td height="3" align="center"><table width="107" border="0" cellpadding="1" cellspacing="1">
            <tr>
              <td width="49">
              	<button type="button" onclick="check()"><img src="image/bt_remove.gif" name="cancel"  align="absmiddle" width="49" height="18"></button>
              </td>
              <td width="51">
              	<button type="button" onclick="history.back()"><img src="image/bt_cancel.gif" name="cancel"  align="absmiddle" width="49" height="18"></button>
              </td>
